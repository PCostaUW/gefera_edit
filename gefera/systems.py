...
class System:
    ...
    def lightcurve(self, t, u1, u2, r1, r2, grad=False, integrate=None, dt=None):
        ...
        if grad:
            ...
            dfdsig1 = grad['e1']*de1decosw(e1sinw,e1cosw) + grad['w1']*dw1decosw(e1sinw,e1cosw) + grad['a1']*dadecosw(b1,T,p1,e1sinw,e1cosw) + grad['i1']*di1decosw(b1,T1,p1,e1sinw,e1cosw) + grad['t1']*dtpdecosw(p,e1sinw,e1cosw)
